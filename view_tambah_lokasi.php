      ...
      <div class="container-fluid">
        ...
        <form class="user" action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama tambal ban">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput1">Alamat tambal ban</label>
              <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat tambal ban">
